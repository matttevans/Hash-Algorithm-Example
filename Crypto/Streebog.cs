...
namespace HashAlgorithmExample.Crypto {
    ...
    /// <summary>
    /// Implementation of GOST R 34.11-2012
    /// </summary>
    public static class Streebog {
		...
		static Streebog() {
            ...
            vector0 = new byte[64];
            vector1 = vector0.Select(x => (byte)1).ToArray();
        }
        ...
        public static string GetHashCode(string input, int n) {
            ...
            // Stage 2 - compressing the message to <512 bits
            while (M.Length > 64) {
            ...
            // Stage 3 - calculating the hash code
            m = new byte[64];
        ...
        /// </summary>
        private static byte[] CompressionFunction(byte[] N, byte[] h, byte[] m) {
        ...
        /// Is a transformation
        /// </summary>
        private static byte[] TransE(byte[] K, byte[] m) {
        ...
        /// </summary>
        /// <param name="K">Previous iteration key</param>
        ...
        /// <summary>
        /// Performs an L-transform
        /// </summary>
        private static byte[] TransL(byte[] a) {
        ...
        /// <summary>
        /// Performs a P transform
        /// </summary>
        private static byte[] TransP(byte[] a) {
            byte[] result = new byte[64];
            for (int i = 0; i < 64; i++) {
                result[i] = a[t[i]];
            }
        ...
        /// <summary>
        /// Performs S-transform
        /// </summary>
        private static byte[] TransS(byte[] a) {
            byte[] result = new byte[64];
            for (int i = 0; i < 64; i++) {
                result[i] = pi[a[i]];
            }
